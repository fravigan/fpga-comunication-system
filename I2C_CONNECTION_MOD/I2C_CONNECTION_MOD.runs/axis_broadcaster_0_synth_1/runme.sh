...
HD_PWD='C:/Users/Francesco/Documents/TESI/Progetti/I2C_CONNECTION_MOD/I2C_CONNECTION_MOD.runs/axis_broadcaster_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_broadcaster_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_broadcaster_0.tcl
