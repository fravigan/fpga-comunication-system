...
design_libs=(xpm axis_infrastructure_v1_1_0 axis_data_fifo_v2_0_10 xil_defaultlib)
...
reset_run()
{
  files_to_remove=(ucli.key axis_data_fifo_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_data_fifo_1_simv.daidir vcs_lib c.obj)
