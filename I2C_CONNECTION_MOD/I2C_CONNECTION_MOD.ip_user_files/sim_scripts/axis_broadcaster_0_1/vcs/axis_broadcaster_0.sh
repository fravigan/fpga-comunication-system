...
design_libs=(xpm axis_infrastructure_v1_1_0 xil_defaultlib axis_broadcaster_v1_1_27)
...
compile()
{
  ...
  vlogan -work axis_broadcaster_v1_1_27 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
reset_run()
{
  files_to_remove=(ucli.key axis_broadcaster_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_broadcaster_0_simv.daidir vcs_lib c.obj)
