...
design_libs=(axis_infrastructure_v1_1_0 axis_register_slice_v1_1_28 axis_switch_v1_1_28 xil_defaultlib)
...
reset_run()
{
  files_to_remove=(ucli.key axis_switch_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_switch_0_simv.daidir vcs_lib c.obj)
