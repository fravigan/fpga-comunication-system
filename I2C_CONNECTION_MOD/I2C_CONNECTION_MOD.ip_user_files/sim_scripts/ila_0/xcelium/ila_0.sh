...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../I2C_CONNECTION_MOD.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../I2C_CONNECTION_MOD.gen/sources_1/ip/ila_0/hdl/verilog" \
