...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axis_infrastructure_v1_1_0 -L xil_defaultlib -L axis_broadcaster_v1_1_27 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_broadcaster_0 xil_defaultlib.axis_broadcaster_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_broadcaster_0 -key {Behavioral:Lettura:Functional:axis_broadcaster_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_broadcaster_0.wdb xsim.dir libdpi.so)
